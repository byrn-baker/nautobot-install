...
SECRET_KEY = os.getenv("NAUTOBOT_SECRET_KEY", "!c14f+&a5snz15%8x+bd=p6*=@a1)8!8is(tp1e96it3d0syx-")
...
NAPALM_USERNAME = os.getenv("NAUTOBOT_NAPALM_USERNAME", "nautobot")
NAPALM_PASSWORD = os.getenv("NAUTOBOT_NAPALM_PASSWORD", "N@utobot123")
